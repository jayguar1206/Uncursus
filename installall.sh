...
echo -e "\e[31mWelcome to Uncursus Install Script V0.5.2.1 (Alha) By @Yaya4_4 Follow Me On Twitter Pls.\e[0m"
...
unzip /User/Documents/Uncursus/DebPatch.zip?raw=true --directory-prefix=/User/Documents/Uncursus/DebPatch
