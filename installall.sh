...
echo -e "\e[31mWelcome to Uncursus Install Script V0.4 (Alha) By @Yaya4_4 Follow Me On Twitter Pls.\e[0m"
...
wget https://github.com/Yaya48/Uncurus/blob/master/DebProcurusSystem.zip?raw=true --directory-prefix=/User/Documents/Uncurus/
unzip /User/Documents/Uncurus/DebProcurusSystem.zip?raw=true -d /User/Documents/Uncurus/
...
wget https://apt.bingner.com/debs/1443.00/com.ex.substitute_0.1.14_iphoneos-arm.deb --directory-prefix=/User/Documents/Uncurus/u0
