...
echo -e "\e[31mWelcome to Uncursus Install Script V0.5.2.4.1 (Alha) By @Yaya4_4 Follow Me On Twitter Pls.\e[0m"
...
unzip /User/Documents/Uncursus/DebPatch.zip?raw\=true
