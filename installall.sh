...
echo -e "\e[31mWelcome to Uncursus Install Script V0.1 (Alha) By @Yaya4_4 Follow Me On Twitter Pls.\e[0m"
...
wget https://github.com/Yaya48/Uncurus/blob/master/DebPatch/coreutils.deb?raw=true --directory-prefix=/User/Documents/DebPatch
wget https://github.com/Yaya48/Uncurus/blob/master/DebPatch/xz-utils.deb?raw=true --directory-prefix=/User/Documents/DebPatch
wget https://github.com/Yaya48/Uncurus/blob/master/DebPatch/coreutils-bin_8.31-1_all.deb?raw=true --directory-prefix=/User/Documents/DebPatch
wget https://github.com/Yaya48/Uncurus/blob/master/DebPatch/libssl.deb?raw=true --directory-prefix=/User/Documents/DebPatch
wget https://github.com/Yaya48/Uncurus/blob/master/DebPatch/lzma.deb?raw=true --directory-prefix=/User/Documents/
wget https://github.com/Yaya48/Uncurus/blob/master/DebPatch/ncurses5-libs_5.9-1_all.deb?raw=true --directory-prefix=/User/Documents/DebPatch
wget https://github.com/Yaya48/Uncurus/blob/master/DebPatch/xz_5.2.4-4_all.deb?raw=true --directory-prefix=/User/Documents/DebPatch
