...
echo -e "\e[31mWelcome to Uncursus Install Script V0.5.1 (Alha) By @Yaya4_4 Follow Me On Twitter Pls.\e[0m"
...
unzip /User/Documents/Procurus/DebPatch.zip?raw=true --directory-prefix=/User/Documents/Uncursus/DebPatch
