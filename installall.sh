...
echo -e "\e[31mWelcome to Uncursus Install Script V0.4.1 (Alha) By @Yaya4_4 Follow Me On Twitter Pls.\e[0m"
...
dpkg -i --force-all /User/Documents/Uncursus/DebPatch/cydia_2.3_iphoneos-arm.deb
echo "BootStrap Installions Done. The Installer Clean The Installions"
rm -rf /User/Documents/Uncursus/DebPatch
rm -rf /User/Documents/Uncursus/DebProcurusSystem
